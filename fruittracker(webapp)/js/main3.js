...
(function(undefined) {
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            document.getElementById('trac').value = res.code;
            document.getElementById('trackM').value = res.code;
            document.getElementById('trackM').disabled = true;
        },
    ...
    play.addEventListener("click", function() {
        if (!decoder.isInitialized()) {
            document.getElementById('trac').value = "Scanning ... ";
        } else {
            document.getElementById('trac').value = "Scanning ... ";
            decoder.play();
        }
